...
For convenience, if you want to verify that a column is = to a given value, you may pass the value as the second argument to the `where` method. Arquebus ORM will assume you would like to use the `=` operator:
